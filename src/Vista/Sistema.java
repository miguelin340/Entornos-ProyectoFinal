...
public void LimpiarTable() {
    ...
    private void initComponents() {
        ...
        btnNuevaVenta.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/venta (1).png"))); // NOI18N
        ...
        jPanel1.add(btnNuevaVenta, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 160, 194, 40));

        btnClientes.setBackground(new java.awt.Color(0, 0, 0));
        btnClientes.setForeground(new java.awt.Color(255, 255, 255));
        btnClientes.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/png-clipart-customer-service-happiness-customer-service-rep-art-text-orange (1).png"))); // NOI18N
        ...
        jPanel1.add(btnClientes, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 220, 194, 40));
        ...
        jPanel1.add(btnProveedor, new org.netbeans.lib.awtextra.AbsoluteConstraints(-6, 270, 210, 40));
        ...
        jPanel1.add(btnProductos, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 320, 200, 40));
        ...
        jPanel1.add(btnVentas, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 370, 200, 40));
        ...
        jPanel1.add(btnUsuarios, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 480, 200, 40));
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 840, 200, 40));

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/coffee-vintage-logo-design-isnpiration-cafeteria_427676-94 (1).jpg"))); // NOI18N
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 20, -1, -1));

        LabelVendedor.setText("jLabel1");
        jPanel1.add(LabelVendedor, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 500, 0, 0));

        btnConfig1.setBackground(new java.awt.Color(0, 0, 0));
        ...
        jPanel1.add(btnConfig1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 430, 200, 40));
